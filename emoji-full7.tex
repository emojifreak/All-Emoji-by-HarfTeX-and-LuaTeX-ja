...
\newcommand{\fontA}[1]{{\ltjsetparameter{jacharrange={-33}}\fontspec[RawFeature={mode=harf,dist,ccmp}]{Segoe UI Emoji} #1\ltjsetparameter{jacharrange={+33}}}}
\newcommand{\fontB}[1]{{\ltjsetparameter{jacharrange={-33}}\fontspec[RawFeature={mode=harf,dist,ccmp}]{Noto Color Emoji} #1\ltjsetparameter{jacharrange={+33}}}}
\usepackage{longtable}
\usepackage[luatex,margin=7mm]{geometry}
