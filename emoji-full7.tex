...
% Build from https://unicode.org/emoji/charts/emoji-list.html
...
\newcommand{\fontA}[1]{{\ltjsetparameter{jacharrange={-9}}\fontspec[RawFeature={mode=harf,dist,ccmp}]{Segoe UI Emoji} #1\ltjsetparameter{jacharrange={+9}}}}
\newcommand{\fontB}[1]{{\ltjsetparameter{jacharrange={-9}}\fontspec[RawFeature={mode=harf,dist,ccmp}]{Noto Color Emoji} #1\ltjsetparameter{jacharrange={+9}}}}
\usepackage{longtable}
\usepackage[luatex,margin=7mm]{geometry}
...
%\fontA{\#️⃣}&\fontB{\#️⃣}&U+0023 U+FE0F U+20E3 \#️⃣ keycap: #\\
